function graph(input)
{
    var dim = {
        ...
        width: $("#graph_canvas_buffer").width(), height: $("#graph_canvas_buffer").height(),
    ...
    var svg = d3.select("#graph_canvas_buffer");
    ...
    svg.append('text')
            .attr("class", "symbol")
            .attr("x", 20)
            .text(input).style("fill", "white").style( "font-size", "17px");
    ...
    ohlcSelection.append("g")
        ...
        .append("text")
            ...
            .text("PRICE [USD]").style("fill", "white");
    ...
    svg.append("g")
        ...
        var path = "../static/crypto_data/graphs/" + input.trim() + "_graph.csv";
